...
##              6. Plot the subset data between DateTime and Global_active_power. Label Y Axis as "Global Active Power (kilowatts)"
...
plot( dataHPCSubset$Datetime, dataHPCSubset$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)" )
